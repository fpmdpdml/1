...
int main()
{
    ...
    short int anew3[68346];
    short int bnew3[68346];
    short int cnew3[68346];
    short int dnew3[68346];
    short int enew3[68346];
    short int fnew3[68346];
    short int gnew3[68346];

    OpenFile.open("C:\\lammps/final/23/6ring/final/61.txt");

    for (int a=1; a<68346; a++)
    {
        string ch1;
        string ch2;
        string ch3;
    ...
    for (int index3=1; index3<68346; index3++)
    {
    ...
    fstream Out;
    Out.open("C:\\lammps/final/23/6ring/final/6f1.txt");
    for (int index1=1; index1<239; index1++)
    {
