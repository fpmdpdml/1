...
int main()
{
    ...
    OpenFile.open("C:\\lammps/final/23/6ring/final/2.txt");
    ...
    short int anew3[67222];
    short int bnew3[67222];
    short int cnew3[67222];
    short int dnew3[67222];
    short int enew3[67222];
    short int fnew3[67222];
    short int gnew3[67222];

    OpenFile.open("C:\\lammps/final/23/6ring/final/62.txt");

    for (int a=1; a<67222; a++)
    {
        string ch1;
        string ch2;
        string ch3;
    ...
    for (int index3=1; index3<67222; index3++)
    {
    ...
    fstream Out;
    Out.open("C:\\lammps/final/23/6ring/final/6f2.txt");
    for (int index1=1; index1<176; index1++)
    {
