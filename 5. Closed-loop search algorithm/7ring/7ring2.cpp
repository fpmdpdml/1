...
int main()
{
    ...
    short int anew3[37424];
    short int bnew3[37424];
    short int cnew3[37424];
    short int dnew3[37424];
    short int enew3[37424];
    short int fnew3[37424];

    OpenFile.open("C:\\lammps/final/23/6ring/52.txt");

    for (int a=1; a<37424; a++)
    {
        string ch1;
        string ch2;
        string ch3;
    ...
    short int anew4[67222];
    short int bnew4[67222];
    short int cnew4[67222];
    short int dnew4[67222];
    short int enew4[67222];
    short int fnew4[67222];
    short int gnew4[67222];

    int index3=1;
    int index4=1;


    for (int index3=1; index3<37424; index3++)
    {
    ...
    fstream Out;
    Out.open("C:\\lammps/final/23/6ring/62.txt");
    for (int index1=1; index1<67222; index1++)
    {
