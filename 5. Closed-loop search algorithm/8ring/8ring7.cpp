...
int main()
{
    ...
    short int anew3[16928];
    short int bnew3[16928];
    short int cnew3[16928];
    short int dnew3[16928];
    short int enew3[16928];
    short int fnew3[16928];
    short int gnew3[16928];

    OpenFile.open("C:\\lammps/final/23/7ring/67.txt");

    for (int a=1; a<16928; a++)
    {
        string ch1;
        string ch2;
        string ch3;
    ...
    short int anew4[35200];
    short int bnew4[35200];
    short int cnew4[35200];
    short int dnew4[35200];
    short int enew4[35200];
    short int fnew4[35200];
    short int gnew4[35200];
    short int hnew4[35200];

    int index3=1;
    int index4=1;


    for (int index3=1; index3<16928; index3++)
    {
    ...
    fstream Out;
    Out.open("C:\\lammps/final/23/7ring/77.txt");
    for (int index1=1; index1<35200; index1++)
    {
