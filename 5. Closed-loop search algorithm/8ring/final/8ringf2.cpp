...
int main()
{
    ...
    short int anew3[59233];
    short int bnew3[59233];
    short int cnew3[59233];
    short int dnew3[59233];
    short int enew3[59233];
    short int fnew3[59233];
    short int gnew3[59233];
    short int hnew3[59233];

    OpenFile.open("C:\\lammps/final/23/7ring/final/723.txt");

    for (int a=1; a<59233; a++)
    {
        string ch1;
        string ch2;
        string ch3;
    ...
    for (int index3=1; index3<59233; index3++)
    {
    ...
    fstream Out;
    Out.open("C:\\lammps/final/23/7ring/final/723f2.txt");
    for (int index1=1; index1<368; index1++)
    {
        ...
        // Out<<anew4[index1]<<" "<<bnew4[index1]<<" "<<cnew4[index1]<<" "<<dnew4[index1]<<" "<<enew4[index1]<<" "<<fnew4[index1]<<" "<<gnew4[index1]<<" "<<hnew4[index1]<<" "<<inew4[index1]<<endl;
    }
    Out.close();
    /*
