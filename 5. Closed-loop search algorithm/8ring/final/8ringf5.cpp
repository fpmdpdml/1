...
int main()
{
    ...
    short int anew3[58131];
    short int bnew3[58131];
    short int cnew3[58131];
    short int dnew3[58131];
    short int enew3[58131];
    short int fnew3[58131];
    short int gnew3[58131];
    short int hnew3[58131];

    OpenFile.open("C:\\lammps/final/23/7ring/final/778.txt");

    for (int a=1; a<58131; a++)
    {
        string ch1;
        string ch2;
        string ch3;
    ...
    for (int index3=1; index3<58131; index3++)
    {
    ...
    fstream Out;
    Out.open("C:\\lammps/final/23/7ring/final/778f5.txt");
    for (int index1=1; index1<206; index1++)
    {
