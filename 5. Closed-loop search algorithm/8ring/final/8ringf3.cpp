...
int main()
{
    ...
    short int anew3[57763];
    short int bnew3[57763];
    short int cnew3[57763];
    short int dnew3[57763];
    short int enew3[57763];
    short int fnew3[57763];
    short int gnew3[57763];
    short int hnew3[57763];

    OpenFile.open("C:\\lammps/final/23/7ring/final/745.txt");

    for (int a=1; a<57763; a++)
    {
        string ch1;
        string ch2;
        string ch3;
    ...
    for (int index3=1; index3<57763; index3++)
    {
    ...
    fstream Out;
    Out.open("C:\\lammps/final/23/7ring/final/745f3.txt");
    for (int index1=1; index1<316; index1++)
    {
