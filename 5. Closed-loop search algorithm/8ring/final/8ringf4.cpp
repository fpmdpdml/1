...
int main()
{
    ...
    short int anew3[32613];
    short int bnew3[32613];
    short int cnew3[32613];
    short int dnew3[32613];
    short int enew3[32613];
    short int fnew3[32613];
    short int gnew3[32613];
    short int hnew3[32613];

    OpenFile.open("C:\\lammps/final/23/7ring/final/76.txt");

    for (int a=1; a<32613; a++)
    {
        string ch1;
        string ch2;
        string ch3;
    ...
    for (int index3=1; index3<32613; index3++)
    {
    ...
    fstream Out;
    Out.open("C:\\lammps/final/23/7ring/final/76f4.txt");
    for (int index1=1; index1<114; index1++)
    {
