...
int main()
{
    ...
    short int anew3[13810];
    short int bnew3[13810];
    short int cnew3[13810];
    short int dnew3[13810];
    short int enew3[13810];
    short int fnew3[13810];
    short int gnew3[13810];

    OpenFile.open("C:\\lammps/final/23/7ring/61.txt");

    for (int a=1; a<13810; a++)
    {
        string ch1;
        string ch2;
        string ch3;
    ...
    short int anew4[25286];
    short int bnew4[25286];
    short int cnew4[25286];
    short int dnew4[25286];
    short int enew4[25286];
    short int fnew4[25286];
    short int gnew4[25286];
    short int hnew4[25286];

    int index3=1;
    int index4=1;


    for (int index3=1; index3<13810; index3++)
    {
    ...
    fstream Out;
    Out.open("C:\\lammps/final/23/7ring/71.txt");
    for (int index1=1; index1<25286; index1++)
    {
