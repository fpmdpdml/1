...
int main()
{
    ...
    short int anew3[8768];
    short int bnew3[8768];
    short int cnew3[8768];
    short int dnew3[8768];
    short int enew3[8768];
    short int fnew3[8768];
    short int gnew3[8768];

    OpenFile.open("C:\\lammps/final/23/7ring/60.txt");

    for (int a=1; a<8768; a++)
    {
        string ch1;
        string ch2;
        string ch3;
    ...
    short int anew4[16083];
    short int bnew4[16083];
    short int cnew4[16083];
    short int dnew4[16083];
    short int enew4[16083];
    short int fnew4[16083];
    short int gnew4[16083];
    short int hnew4[16083];

    int index3=1;
    int index4=1;


    for (int index3=1; index3<8768; index3++)
    {
    ...
    fstream Out;
    Out.open("C:\\lammps/final/23/7ring/70.txt");
    for (int index1=1; index1<16083; index1++)
    {
