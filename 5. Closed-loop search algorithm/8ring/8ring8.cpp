...
int main()
{
    ...
    short int anew3[14697];
    short int bnew3[14697];
    short int cnew3[14697];
    short int dnew3[14697];
    short int enew3[14697];
    short int fnew3[14697];
    short int gnew3[14697];

    OpenFile.open("C:\\lammps/final/23/7ring/68.txt");

    for (int a=1; a<14697; a++)
    {
        string ch1;
        string ch2;
        string ch3;
    ...
    for (int index3=1; index3<14697; index3++)
    {
    ...
    fstream Out;
    Out.open("C:\\lammps/final/23/7ring/78.txt");
