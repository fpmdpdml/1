...
int main()
{
    ...
    short int anew3[17671];
    short int bnew3[17671];
    short int cnew3[17671];
    short int dnew3[17671];
    short int enew3[17671];
    short int fnew3[17671];
    short int gnew3[17671];

    OpenFile.open("C:\\lammps/final/23/7ring/66.txt");

    for (int a=1; a<17671; a++)
    {
        string ch1;
        string ch2;
        string ch3;
    ...
    short int anew4[38286];
    short int bnew4[38286];
    short int cnew4[38286];
    short int dnew4[38286];
    short int enew4[38286];
    short int fnew4[38286];
    short int gnew4[38286];
    short int hnew4[38286];

    int index3=1;
    int index4=1;


    for (int index3=1; index3<17671; index3++)
    {
    ...
    fstream Out;
    Out.open("C:\\lammps/final/23/7ring/76.txt");
    for (int index1=1; index1<38286; index1++)
    {
