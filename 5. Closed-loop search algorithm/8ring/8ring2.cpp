...
int main()
{
    ...
    short int anew3[15617];
    short int bnew3[15617];
    short int cnew3[15617];
    short int dnew3[15617];
    short int enew3[15617];
    short int fnew3[15617];
    short int gnew3[15617];

    OpenFile.open("C:\\lammps/final/23/7ring/62.txt");

    for (int a=1; a<15617; a++)
    {
        string ch1;
        string ch2;
        string ch3;
    ...
    for (int index3=1; index3<15617; index3++)
    {
    ...
    fstream Out;
    Out.open("C:\\lammps/final/23/7ring/72.txt");
