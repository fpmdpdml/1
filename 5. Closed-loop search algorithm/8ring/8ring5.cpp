...
int main()
{
    ...
    short int anew3[15940];
    short int bnew3[15940];
    short int cnew3[15940];
    short int dnew3[15940];
    short int enew3[15940];
    short int fnew3[15940];
    short int gnew3[15940];

    OpenFile.open("C:\\lammps/final/23/7ring/65.txt");

    for (int a=1; a<15940; a++)
    {
        string ch1;
        string ch2;
        string ch3;
    ...
    for (int index3=1; index3<15940; index3++)
    {
    ...
    fstream Out;
    Out.open("C:\\lammps/final/23/7ring/75.txt");
