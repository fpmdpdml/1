...
int main()
{
    ...
    for (int index2=1; index2<21167; index2++)
    {
        ...
        {
            if ((o%2==1) && dnew2[index2]==array[o] && bnew2[index2]!=array[o+1] &&  cnew2[index2]!=array[o+1] &&  bnew2[index2]!=dnew2[index2] && cnew2[index2]!=dnew2[index2] && anew2[index2]==array[o+1])
            {
            ...
            else if ((o%2==0) && dnew2[index2]==array[o] && bnew2[index2]!=array[o-1] &&  cnew2[index2]!=array[o-1] &&  bnew2[index2]!=dnew2[index2] && cnew2[index2]!=dnew2[index2]  && anew2[index2]==array[o-1])
            {
                anew3[index3]=anew2[index2];
                bnew3[index3]=bnew2[index2];
                cnew3[index3]=cnew2[index2];
    ...
    {
        Out<<"topo addbond "<<anew3[index1]<<" "<<bnew3[index1]<<" "<<endl;
        Out<<"topo addbond "<<bnew3[index1]<<" "<<cnew3[index1]<<" "<<endl;
        Out<<"topo addbond "<<cnew3[index1]<<" "<<dnew3[index1]<<" "<<endl;
        Out<<"topo addbond "<<dnew3[index1]<<" "<<enew3[index1]<<" "<<endl;
    }
    Out.close();
