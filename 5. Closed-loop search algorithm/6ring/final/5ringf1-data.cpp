...
int main()
{
    ...
    short int anew3[37956];
    short int bnew3[37956];
    short int cnew3[37956];
    short int dnew3[37956];
    short int enew3[37956];
    short int fnew3[37956];

    OpenFile.open("C:\\lammps/final/23/5ring/final/51.txt");

    for (int a=1; a<37956; a++)
    {
        string ch1;
        string ch2;
        string ch3;
    ...
    short int anew4[3431];
    short int bnew4[3431];
    short int cnew4[3431];
    short int dnew4[3431];
    short int enew4[3431];
    short int fnew4[3431];
    short int gnew4[3431];

    int index3=1;
    int index4=1;


    for (int index3=1; index3<37956; index3++)
    {
    ...
    fstream Out;
    Out.open("C:\\lammps/final/23/5ring/final/new1.txt");
    for (int index1=1; index1<3431; index1++)
    {

        Out<<6*index1-5<<" "<<1<<" "<<anew4[index1]+1<<" "<<bnew4[index1]+1<<endl;
        Out<<6*index1-4<<" "<<1<<" "<<bnew4[index1]+1<<" "<<cnew4[index1]+1<<endl;
        Out<<6*index1-3<<" "<<1<<" "<<cnew4[index1]+1<<" "<<dnew4[index1]+1<<endl;
        Out<<6*index1-2<<" "<<1<<" "<<dnew4[index1]+1<<" "<<enew4[index1]+1<<endl;
        Out<<6*index1-1<<" "<<1<<" "<<enew4[index1]+1<<" "<<fnew4[index1]+1<<endl;
        Out<<6*index1<<" "<<1<<" "<<fnew4[index1]+1<<" "<<gnew4[index1]+1<<endl;
