...
int main()
{
    ...
    OpenFile.open("C:\\lammps/final/23/5ring/2.txt");
    ...
    OpenFile.open("C:\\lammps/final/23/5ring/4.txt");
    ...
    short int anew4[75424];
    short int bnew4[75424];
    short int cnew4[75424];
    short int dnew4[75424];
    short int enew4[75424];
    short int fnew4[75424];
    ...
    fstream Out;
    Out.open("C:\\lammps/final/23/5ring/5.txt");
    for (int index1=1; index1<75424; index1++)
    {


        Out<<anew4[index1]<<" "<<bnew4[index1]<<" "<<cnew4[index1]<<" "<<dnew4[index1]<<" "<<enew4[index1]<<" "<<fnew4[index1]<<endl;
